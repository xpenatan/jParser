...
val testLibFfmBuildTask = ":examples:TestLib:lib:builder:TestLib_build_project_${hostTarget}_ffm"
...
tasks.register<JavaExec>("TestLib_throughput_benchmark_compare") {
    ...
    dependsOn(":examples:TestLib:app:platforms:desktop-jni:TestLib_throughput_benchmark_jni", "TestLib_throughput_benchmark_ffm")
...
tasks.register<JavaExec>("TestLib_fps_benchmark_compare") {
    ...
    dependsOn(":examples:TestLib:app:platforms:desktop-jni:TestLib_fps_benchmark_jni", "TestLib_fps_benchmark_ffm")
...
tasks.register<JavaExec>("TestLib_enum_benchmark_compare") {
    ...
    dependsOn(":examples:TestLib:app:platforms:desktop-jni:TestLib_enum_benchmark_jni", "TestLib_enum_benchmark_ffm")
...
tasks.named("TestLib_throughput_benchmark_ffm") {
    mustRunAfter(":examples:TestLib:app:platforms:desktop-jni:TestLib_throughput_benchmark_jni")
}

tasks.named("TestLib_fps_benchmark_ffm") {
    mustRunAfter(":examples:TestLib:app:platforms:desktop-jni:TestLib_fps_benchmark_jni")
}

tasks.named("TestLib_enum_benchmark_ffm") {
    mustRunAfter(":examples:TestLib:app:platforms:desktop-jni:TestLib_enum_benchmark_jni")
}
