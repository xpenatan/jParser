package com.github.xpenatan.jParser.example.app.testlibandroidc;
...
public class TeaVMCHeadlessMain {
    ...
    public static void main(String[] args) {
        ...
        if(!TestLib.test()) {
            printFailures();
            throw new AssertionError("TestLib Android-C tests failed");
        }
        System.out.println("TestLib Android-C tests passed");
    }
