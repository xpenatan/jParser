...
dependencies {
    ...
    iosResources(project(":examples:TestLib:lib:ios:TestLib-ios-c"))
}
...
val generateTeaVMC by tasks.registering(JavaExec::class) {
    group = "example-ios"
    description = "Generate TestLib TeaVM C sources for the custom iOS emulator"
...
val configureIosSimulator by tasks.registering(Exec::class) {
    group = "example-ios"
    description = "Configure the custom TestLib iOS emulator project"
...
val buildIosSimulator by tasks.registering(Exec::class) {
    group = "example-ios"
    description = "Build the custom TestLib TeaVM C iOS emulator app"
...
tasks.register("TestLib_build_app_ios_c") {
    group = "example-ios"
    description = "Build the custom TestLib iOS emulator application backed by TeaVM C"
