package com.github.xpenatan.jParser.example.app.testlibiosc;
...
/** Java entry point embedded in the handwritten TestLib iOS emulator app. */
public class TeaVMCEmulatorMain {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("TestLib iOS TeaVM C binding tests passed");
    }
