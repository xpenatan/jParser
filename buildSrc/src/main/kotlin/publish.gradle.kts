...
var libProjects = mutableSetOf(
    ...
    project(":jParser:runtime:web:wasm"),
    project(":jParser:runtime:shared:jni"),
    project(":jParser:runtime:desktop:ffm"),
    project(":jParser:runtime:android:jni"),
    project(":jParser:runtime:shared:c"),
    project(":jParser:runtime:desktop:c"),
    project(":jParser:runtime:android:c"),
