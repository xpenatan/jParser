...
var libProjects = mutableSetOf(
    ...
    project(":jParser:runtime:base"),
    project(":jParser:runtime:core"),
    project(":jParser:runtime:web:runtime-web"),
    project(":jParser:runtime:shared:runtime-jni"),
    project(":jParser:runtime:desktop:runtime-desktop-jni"),
    project(":jParser:runtime:desktop:runtime-desktop-ffm"),
    project(":jParser:runtime:android:runtime-android"),
    project(":jParser:runtime:shared:runtime-c"),
