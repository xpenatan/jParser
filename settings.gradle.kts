...
include(":examples:TestLib:lib:lib-teavm-web")
...
include(":examples:TestLib:app:teavm-web")
...
include(":examples:SharedLib:libA:lib-teavm-web")
...
include(":examples:SharedLib:libB:lib-teavm-web")
...
include(":examples:SharedLib:app:teavm-web")
