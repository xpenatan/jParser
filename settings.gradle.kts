...
include(":jParser:runtime:web:wasm")
include(":jParser:runtime:shared:jni")
include(":jParser:runtime:desktop:ffm")
include(":jParser:runtime:android:jni")
include(":jParser:runtime:shared:c")
include(":jParser:runtime:desktop:c")
include(":jParser:runtime:android:c")
