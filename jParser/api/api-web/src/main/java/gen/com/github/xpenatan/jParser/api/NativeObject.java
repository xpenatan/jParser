...
public class NativeObject {
    ...
    public final static NativeObject NULL;
    ...
    public final NativeObject native_setAddress(long voidValue) {
    ...
    public final NativeObject native_setAddress(int voidValue) {
     ...
     */
    public final NativeObject native_reset() {
     ...
     */
    public final void native_copy(NativeObject other) {
        ...
        if(native_cMemOwn) {
            if(!native_disposed) {
                if(native_address != 0) {
                    ...
                    if(NativeObject.ENABLE_LOGGING) {
                        error("Native", "Disposing error - " + this + " native_address is 0");
                    }
                }
            }
            else {
                if(NativeObject.ENABLE_LOGGING) {
                    error("Native", "Disposing warning - " + this + " is already disposed");
                }
            }
        }
        else {
            if(NativeObject.ENABLE_LOGGING) {
                error("Native", "Disposing warning - " + this + " is not memory owned");
            }
        }
    }
    ...
    /**
     * Deletes the Native object this class encapsulates. Do not call directly, instead use the {@link #dispose()} method.
     */
    ...
    public boolean equals(Object obj) {
        if(obj instanceof NativeObject) {
            ...
            return nativeObj.native_address == this.native_address;
        }
        return false;
    }
