            ...
            if(methodReturnType.isVoidType()) {
                ...
                if(IDLDefaultCodeParser.GLOBAL_GEN_DEBUG_LISTENER) {
                    ...
                    if(paramsSb.length() > 0) {
                        notifyCode = "com.github.xpenatan.jparser.runtime.GenerationDebugListener.notify(\"" + className + "\", \"" + methodNameStr + "\", " + paramsSb.toString() + ");";
                    }
                    else {
                        notifyCode = "com.github.xpenatan.jparser.runtime.GenerationDebugListener.notify(\"" + className + "\", \"" + methodNameStr + "\");";
                    }
                    try {
