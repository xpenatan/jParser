...
import runtime.helper.NativeArray;
import runtime.helper.NativeBoolArray;
import runtime.helper.NativeByteArray;
import runtime.helper.NativeDoubleArray;
import runtime.helper.NativeFloatArray;
import runtime.helper.NativeIntArray;
import runtime.helper.NativeLongArray;
...
public class IDLHelper {
    ...
    public static String getJavaType(boolean useIDLArray, String idlType) {
        ...
        if(idlType.equals("any") || idlType.equals("VoidPtr")) {
            type = DefaultCodeParser.Native_Object_CLASS;
        }
        else if(idlType.contains("long long")) {
            type = "long";
        }
    ...
    public static String getIDLArrayClassOrNull(String type) {
        ...
        if(type.equals("int[]")) {
            type = NativeIntArray.class.getSimpleName();
        }
        else if(type.equals("long[]") || type.equals("long long[]")) {
            type = NativeLongArray.class.getSimpleName();
        }
        else if(type.equals("float[]")) {
            type = NativeFloatArray.class.getSimpleName();
        }
        else if(type.equals("byte[]")) {
            type = NativeByteArray.class.getSimpleName();
        }
        else if(type.equals("boolean[]")) {
            type = NativeBoolArray.class.getSimpleName();
        }
        else if(type.equals("double[]")) {
            type = NativeDoubleArray.class.getSimpleName();
        }
        else if(type.endsWith("[]")) {
            type = type.replace("[]", "");
            type = NativeArray.class.getSimpleName() + type;
            return type;
        }
