...
public abstract class IDLClassGeneratorParser extends DefaultCodeParser {
    ...
    public void onParseStart(JParser jParser) {
        ...
        Class<NativeObject> nativeObjClass = NativeObject.class;
        baseItem.packagePathName = nativeObjClass.getPackageName();
        baseItem.className = nativeObjClass.getSimpleName();
...
//                if(classDeclaration != null) {
            ...
            Class<NativeEnum> nativeEnumClass = NativeEnum.class;
            String simpleName = nativeEnumClass.getSimpleName();
            JParserHelper.removeImport(unit, simpleName);
            String importName = nativeEnumClass.getPackageName() + "." + simpleName;
